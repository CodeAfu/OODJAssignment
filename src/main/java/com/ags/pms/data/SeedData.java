...
public class SeedData {
    ...
    public static void init() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
        ...
        PresentationSlot presentationSlot5 = new PresentationSlot(5005, 2003, LocalDateTime.of(2024, 6, 5, 9, 30));
        PresentationSlot presentationSlot6 = new PresentationSlot(5006, 2001, LocalDateTime.of(2024, 6, 6, 10, 0));
        PresentationSlot presentationSlot7 = new PresentationSlot(5007, 2002, LocalDateTime.of(2024, 6, 7, 11, 30));
        PresentationSlot presentationSlot8 = new PresentationSlot(5008, 2003, LocalDateTime.of(2024, 6, 8, 16, 0));
        PresentationSlot presentationSlot9 = new PresentationSlot(5009, 2001, LocalDateTime.of(2024, 6, 9, 12, 0));
        PresentationSlot presentationSlot10 = new PresentationSlot(5010, 2002, LocalDateTime.of(2024, 6, 10, 13, 30));
        PresentationSlot presentationSlot11 = new PresentationSlot(5011, 2003, LocalDateTime.of(2024, 6, 11, 14, 0));
        PresentationSlot presentationSlot12 = new PresentationSlot(5012, 2001, LocalDateTime.of(2024, 6, 12, 15, 30));
        PresentationSlot presentationSlot13 = new PresentationSlot(5013, 2002, LocalDateTime.of(2024, 6, 13, 16, 0));
        PresentationSlot presentationSlot14 = new PresentationSlot(5014, 2003, LocalDateTime.of(2024, 6, 14, 17, 0));
        PresentationSlot presentationSlot15 = new PresentationSlot(5015, 2001, LocalDateTime.of(2024, 6, 15, 18, 30));
        PresentationSlot presentationSlot16 = new PresentationSlot(5016, 2002, LocalDateTime.of(2024, 6, 16, 19, 0));
        PresentationSlot presentationSlot17 = new PresentationSlot(5017, 2003, LocalDateTime.of(2024, 6, 17, 20, 0));
        PresentationSlot presentationSlot18 = new PresentationSlot(5018, 2001, LocalDateTime.of(2024, 6, 18, 21, 30));
        PresentationSlot presentationSlot19 = new PresentationSlot(5019, 2002, LocalDateTime.of(2024, 6, 19, 22, 0));
        PresentationSlot presentationSlot20 = new PresentationSlot(5020, 2003, LocalDateTime.of(2024, 6, 20, 23, 0));
